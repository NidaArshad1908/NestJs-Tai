...
const WorkOrderList: NextPage = () => {
  const [todos, setTodos] = useState<WorkOrder[]>([]);
  const [selectedTodos, setSelectedTodos] = useState<WorkOrder[]>([]);
  ...
  useEffect(() => {
    fetch('http://localhost:4000/workorderslist/all')
  ...
  const handleUpdateAndClose = () => {
    let todoToUpdate: WorkOrder = {
      ...
      kameez: UpdateTitle,
      shalwarkameez: UpdateTitle,
      pant: UpdateTitle,
      kot: UpdateTitle,
      waistcoat: UpdateTitle,
      cutting: UpdateTitle,
      shirtcutting: UpdateTitle,
      pantcutting: UpdateTitle,
      stitchingcost: UpdateTitle,
      designcost: UpdateTitle,
      addedby: UpdateTitle,
  ...
  const createOrUpdate = (todo: WorkOrder) => {
    fetch('http://localhost:4000/workorderslist/createOrUpdate', {
      method: 'POST',
      headers: {
  ...
  const deleteTodo = (event: any) => {
    ...
    fetch(`http://localhost:4000/workorderslist/delete`, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json',
      },
      ...
      <ThemeProvider theme={defaultMaterialTheme}>
        <MaterialTable
          ...
          columns={[
            ...
            { title: 'Worker Name', field: 'name' },
            { title: 'Order Date', field: 'orderdate' },
            { title: 'Kameez', field: 'kameez' },
            { title: 'Shalwar Kameez', field: 'shalwarkameez' },
            { title: 'Pant', field: 'pant' },
            { title: 'Kot', field: 'kot' },
            { title: 'Waist Coat', field: 'waistcoat' },
            { title: 'Cutting', field: 'cutting' },
            { title: 'Shirt Cutting', field: 'shirtcutting' },
            { title: 'Pant Cutting', field: 'pantcutting' },
            { title: 'Stiching Cost', field: 'stitchingcost' },
            { title: 'Design Cost', field: 'designcost' },
          ...
          onSelectionChange={(rows: WorkOrder[]) => {
